...
import numpy as np
khcolors = ['#CC0000','#990000','#CC6633','#996633','#CC9933','#CCCC33','#999933','#666633',\
'#333333','#333366','#000066','#333399','#666699','#9999CC','#999999','#CCCCCC',\
'#999999','#669966','#336633','#003300','#006633','#339966','#009999','#00CCCC']
ranges = [0.0, 0.033, 0.066, 0.1, 0.15, .2, 0.22, 0.26, 0.3, 0.32, 0.34, 0.36, .4, 0.44, 0.48, 0.52, 0.56, .6, 0.66, 0.73, .8, 0.86, 0.92, 1]
khcolordict = {}
#ranges = np.linspace(0,1, len(khcolors))
for c, n in zip(khcolors, ranges):
#    print n,c
    khcolordict[n] = c
khcm = make_colormap(khcolordict)
#showcolors(cm)
